...
import { buyListing, getListingById, isAuthenticated } from "@/api/listings";
        ...
        <div className="grid gap-6 lg:grid-cols-[1.25fr_0.75fr]">
          ...
          <Card className="h-fit border-secondary/20 bg-card/95">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <p>
                Buy lets an authenticated user mark this listing as sold. If you are
                not logged in, we will send you to the login page first.
              </p>
              {isSold && (
            ...
            <CardFooter className="flex-col gap-3">
              ...
              >
                {isSold ? "Item Sold" : isBuying ? "Processing..." : "Buy Now"}
              </Button>
